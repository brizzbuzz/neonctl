...
@Serializable
public data class ProjectCreateRequestProjectBranch(
...
@Serializable
public data class ProjectCreateRequestProject(
  public val settings: ProjectSettingsData,
  public val name: String,
  public val branch: ProjectCreateRequestProjectBranch,
...
public data class ProjectCreateRequest(
  public val project: ProjectCreateRequestProject,
)
